    ...
    private function getProcurementsData()
    {
        return [
            ...
            [
                ...
                'documents' => [
                    ['name' => "E'lon (O'zbekcha)", 'file' => 'Qorasaroy/Эълон _(ЎЗБ).pdf'],
                    ['name' => "E'lon (Ruscha)", 'file' => 'Qorasaroy/Эълон _(РУС).pdf'],
                    ['name' => "Ariza (O'zbekcha)", 'file' => 'Qorasaroy/Ариза _(ЎЗБ).pdf'],
                    ['name' => "Ariza (Ruscha)", 'file' => 'Qorasaroy/Ариза _(РУС).pdf'],
                    ['name' => "Texnik hujjat (O'zbekcha)", 'file' => 'Qorasaroy/Тех_Хужжат_экс_шота_Ислом_Цивилизацияси_маркази_Туннел_ЎЗБ.pdf'],
                    ['name' => "Texnik hujjat (Ruscha)", 'file' => 'Qorasaroy/Тех_Хужжат_экс_шота_Ислом_Цивилизацияси_маркази_Туннел_РУС.pdf'],
                    ['name' => "Texnik topshiriq (O'zbekcha)", 'file' => 'Qorasaroy/ТЕХНИЧЕСКОЕ_ЗАДАНИЕ_Ислом_Цивилизацияси_маркази_Туннел_ЎЗБ.pdf'],
                    ['name' => "Texnik topshiriq (Ruscha)", 'file' => 'Qorasaroy/ТЕХНИЧЕСКОЕ_ЗАДАНИЕ_Ислом_Цивилизацияси_маркази_Туннел_РУС.pdf'],
