...
<div class="admin-page-header">
    <div class="page-header-content">
        <h1><i class="fas fa-edit"></i> Ruxsatni tahrirlash</h1>
        <p>{{ $permission->name }}</p>
    </div>
    ...
    <div class="admin-card-body">
        <form action="{{ route('permissionUpdate', $permission->id) }}" method="POST">
            ...
            <div class="gov-form-group">
                ...
                <input type="text" name="name" class="gov-form-control" value="{{ old('name', $permission->name) }}" required>
                @error('name')
            ...
            <div class="gov-form-group">
                ...
                <input type="text" name="title" class="gov-form-control" value="{{ old('title', $permission->title) }}" placeholder="masalan: Foydalanuvchi qo'shish">
                @error('title')
                    <div class="gov-form-error">{{ $message }}</div>
                @enderror
            </div>
