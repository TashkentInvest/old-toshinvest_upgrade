                            ...
                            <tbody>
                                @php
                                 ...
                                 $fileNames = [
                                    ...
                                    // Corporate documents
                                    'Кодекс корпоративной этики.PDF' => 'Кодекс корпоративной этики',
                                    'политика_АО_Компания_Ташкент_Инвест_по_противодействию_коррупции.PDF' => 'Политика по противодействию коррупции',
                                    'положение о внутреннем контроле.PDF' => 'Положение о внутреннем контроле',
                                    'положение о комитете по Аудиту.PDF' => 'Положение о комитете по аудиту',
                                    'положение_о_дивидендной_политике.PDF' => 'Положение о дивидендной политике',
                                    'положение_о_корпоративном_консультанте.PDF' => 'Положение о корпоративном консультанте',
                                    'положение_о_Наблюдательном_Совете_от_10_11_2023.PDF' => 'Положение о Наблюдательном совете (2023)',
                                    'положение_о_Наблюдательном_Совете.PDF' => 'Положение о Наблюдательном совете',
                                    'положение_о_порядке_выдачи_средств_на_командировочные_расходы_при.PDF' => 'Положение о командировочных расходах',
                                    'положение_о_порядке_действии_при_конфликте_интересов.PDF' => 'Положение о порядке действий при конфликте интересов',
                                    'положение_о_службе_внутренного_аудита.PDF' => 'Положение о службе внутреннего аудита',
                                    'положение_об_информационной_политике.PDF' => 'Положение об информационной политике',
                                    'положение_об_исполнительном_органе_2.PDF' => 'Положение об исполнительном органе (версия 2)',
                                    'положение_об_исполнительном_органе.PDF' => 'Положение об исполнительном органе',
                                    'положение_об_общем_собрании_акционеров.PDF' => 'Положение об общем собрании акционеров',
                                    'положение_об_оказании_благотварительной_и_спонсорской_помощи.PDF' => 'Положение об оказании благотворительной и спонсорской помощи',
                                ];
