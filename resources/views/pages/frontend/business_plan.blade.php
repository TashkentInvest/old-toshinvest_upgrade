            ...
            <div class="t-container_100">
                <div class="t-width t-width_100">
                    ...
                    @php
                        ...
                        $documents = [
                            'Бизнес-план 2024.docx' => 'Бизнес-план 2024',
                            'Бизнес-план 2025.docx' => 'Бизнес-план 2025',
                        ];

                        // File folder
                        $folder = public_path('assets/folders');
                        ...
                        @foreach ($documents as $fileName => $displayName)
                            ...
                            <div style="margin-bottom: 25px; padding: 15px; background: #f9f9f9; border: 1px solid #ccc;">
                                ...
                                @if (file_exists($filePath))
                                    <a href="{{ asset('assets/folders/' . $fileName) }}?v=1.0" download
                    ...
                    <div class="info-section"
                        ...
                        <p style="color: #7f8c8d; font-size: 12px; margin: 0; line-height: 1.5;">
                            ...
                            Документы представлены в формате DOCX и доступны для скачивания.
                        </p>
                    </div>
