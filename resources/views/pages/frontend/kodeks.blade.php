...
@section('frontent_content')
    <div id="rec748394760" class="r t-rec t-rec_pt_120 t-rec_pb_135"
        ...
        <div class="t650">
            ...
            <style>
                ...
                #rec748394760 .t-section__title {
                    margin-bottom: 90px;
                }

                #rec748394760 .t-section__descr {}
  ...
  <div class="t-card__col t-col t-col_4 t-align_left" style="cursor: pointer;">
                    <div class="t650__inner-col" style="background-color: rgb(255, 255, 255); height: 250px;">
                        ...
                        <div class="t650__btn-container">
                            <div class="t-card__btntext-wrapper">
                                <a href="{{asset('assets/frontend/kodeks/Кодекс корпоративной этики.PDF')}}" target="_blank" class="t-card__btn-text t-btntext t-btntext_sm " id="cardbtn5_748394760"
                                    data-field="li_buttontitle__1715716895372" style="color:#193d88;font-weight:600;"
                                    aria-hidden="true" data-buttonfieldset="li_button" data-lid="1715716895372">
                                    Просмотреть</a>
                            </div>
        ...
        <script type="text/javascript">
            t_onReady(function() {
                ...
                if (typeof jQuery !== 'undefined') {
                    ...
                    var rec = document.querySelector('#rec748394760');
                    if (!rec) return;
        ...
        <style>
            #rec748394760 .t650__inner-col {
                box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);
            }
        </style>
        <style>
            #rec748394760 .t650 .t650__inner-col:hover,
            #rec748394760 .t650 .t-focusable .t650__inner-col,
            #rec748394760 .t650 .t-card__col_btnfocusable .t650__inner-col {
