        ...
        @php
            ...
            $versions = [
                [
                    ...
                    'title' => $locale === 'ru'
                        ? 'Финансовый результат АО «Компания Ташкент Инвест» по состоянию на 31 декабря 2025 года.'
                        : ($locale === 'uz'
                            ? '«Toshkent Invest Kompaniyasi» AJining 2025 yil 31 dekabr holatiga moliyaviy natijalar toʼgʼrisidagi hisobot.'
                            : 'Financial Results of JSC «Tashkent Invest Company» as of December 31, 2025.'),
                    'src'   => asset('assets/reports/финансовых результатах/Отчет_о_финансовых_результатах_форма_№2_2025_4кв.pdf'),
                    'latest' => true,
                ],
                [
                    'key'   => 'v2024q1',
                    ...
                    'title' => $locale === 'ru'
                        ? 'Отчет о финансовых результатах АО «Компания Ташкент Инвест» — 1 квартал 2024 года.'
                        : ($locale === 'uz'
                            ? '«Toshkent Invest Kompaniyasi» AJining 2024 yil 1-chorak moliyaviy natijalar hisoboti.'
                            : 'Income Statement of JSC «Tashkent Invest Company» — Q1 2024.'),
