                ...
                <div class="t-width t-width_100">
                    ...
                    <div class="page-header"
                        ...
                        <h1
                            ...
                            Существенные факты {{ $number }}
                        </h1>
                        <a href="{{ route('frontend.essential_facts') }}"
                            style="display: inline-block; margin-top: 15px; padding: 8px 20px; background-color: #7f8c8d; color: #ffffff; text-decoration: none; border-radius: 4px; font-size: 12px; transition: background-color 0.2s;"
                        ...
                        <table class="documents-table"
                            ...
                            <tbody>
                                @php
                                    ...
                                    function formatFileSizeShow($size)
                                    {
                                        if ($size >= 1048576) {
                                ...
                                @if (count($files) > 0)
                                    @foreach ($files as $index => $file)
                                        @php
                                            ...
                                            $displayName = 'Существенные факты ' . $number . (count($files) > 1 ? ' (' . ($index + 1) . ')' : '');
                                        @endphp
                                        ...
                                        <tr
                                            ...
                                            <td style="padding: 12px 20px; text-align: center;">
                                                <div
                                                    ...
                                                    <a href="{{ asset('assets/frontend/muhim_faktlar/' . $file) }}"
                                                        download
                                                        style="display: inline-block; padding: 6px 12px; background-color: #27ae60; color: #ffffff; text-decoration: none; border: 1px solid #229954; font-size: 11px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.3px; transition: background-color 0.2s;"
                                    ...
                                    <tr>
                                        <td colspan="4"
                                           ...
                                           <div style="font-weight: 600; margin-bottom: 5px;">ДОКУМЕНТЫ НЕ НАЙДЕНЫ</div>
                                            <div style="font-size: 12px;">В этой категории нет документов.</div>
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
                    ...
                    <div class="stats-section"
                        ...
                        <div
                            ...
                            <div style="text-align: center; padding: 15px;">
                                <div style="font-size: 24px; font-weight: 700; color: #2c3e50; margin-bottom: 5px;">
                                    {{ formatFileSizeShow($totalSize) }}</div>
                                <div
                                    style="font-size: 12px; color: #7f8c8d; text-transform: uppercase; letter-spacing: 0.5px;">
                                    ОБЩИЙ РАЗМЕР</div>
                            </div>
                    ...
                    <div class="info-section"
                        ...
                        <p style="color: #7f8c8d; font-size: 12px; margin: 0; line-height: 1.5;">
                            Все документы представлены в формате PDF и доступны для просмотра и скачивания.<br>
                            Нажмите "ОТКРЫТЬ" для просмотра в браузере или "СКАЧАТЬ" для сохранения на устройство.
                        </p>
                    </div>
